...
/**
  ...
  *
  * NOTE: You only need to submit the code above, after filling in the blanks appropriately. The input and output section will be handled by us.
  * The focus is on writing the correct function.
  */
